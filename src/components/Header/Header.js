...
import { VideBackground} from './HeaderElements';
//import Video from '../../images/aurora.mp4';
    ...
    render(){
        return(
            <section className={styles.header} id="home">
                <VideBackground autoPlay loop muted src='https://imgur.com/JzKOSTu' type='video/mp4' />
                <br/>
