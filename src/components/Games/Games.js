                ...
                <div className={styles.gamesContainer}>
                    <div className={styles.game}><img className={styles.gamesImg} src="https://i.postimg.cc/hjvDLsvg/sd-Sorcerer.png"></img>
                        <div className={styles.gamesDescription}>
                            ...
                            <p className={styles.gamesDescriptionText2}> Check how the work goessss</p>
                        </div>
                    </div>
                    ...
                    <div className={styles.gamesDescription}>
                            ...
                            <p  className={styles.gamesDescriptionText}> Dimension eye is a platformer game telling story about society of "eye power", where the strongest eyes are ...
                             You only know about the one of them, the dimension eye, which controls physical matter, what about rest of the eyes? Find and check them out :)</p>
